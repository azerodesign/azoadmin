        ...
        <header className="flex justify-between items-center mb-8">
          <div className="relative w-96">
            ...
            <input
              ...
              className="w-full bg-white border-none rounded-full py-3 pl-10 pr-12 shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20"
            />
            <span className="absolute right-3 top-1/2 -translate-y-1/2 bg-gray-100 text-gray-500 text-xs px-2 py-1 rounded">⌘ F</span>
          </div>
